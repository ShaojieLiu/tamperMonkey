...
(function() {
    ...
    let lastTxt = ''
    const translate = () => {
        const arr = Array.from(document.querySelectorAll('.vjs-text-track-display'))
        arr && [arr[0]].forEach(titleDiv => {
            const title = titleDiv.querySelector('div').querySelector('div').querySelector('div');
